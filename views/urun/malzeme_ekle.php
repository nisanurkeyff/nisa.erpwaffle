...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="/assets/" data-template="vertical-menu-template" data-style="light">
    <head>
        ...
        <title> <?=$row_site->TITLE?> | Malzeme Ekle </title>
        <?=$cTheme->Linkler()?>
    </head>
    <body>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-merge">
                                                                ...
                                                                <div class="form-floating form-floating-outline">
                                                                    <input type="text" id="malzeme" name="malzeme" class="form-control" value="<?=$_REQUEST['malzeme']?>" onchange="this.value=this.value.turkishToUpper();" placeholder="Malzeme">
                                                                    <label>Malzeme</label>
                                                                </div>
                                                            </div>
                                                        </div>
...
<script type="text/javascript">
    ...
    $("#urunEkle").on("submit", function(event) {
        ...
        $.ajax({
            url: "/router.php",
            type: "POST",
            data: $(this).serialize() + "&controller=urun&action=malzeme_ekle",
            dataType: "json",
            success: function(response) {
                ...
                if (response.HATA) {
                    ...
                    location.href = '/views/urun/malzeme_listesi.php?route=urun/malzeme_listesi'
                }
            }
        });
    });
