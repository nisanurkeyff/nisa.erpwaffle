<?
    ...
    $result             = $cSiparis->getSiparisDetaylar($_REQUEST);
    $rows               = $result['rows'];
                                        ...
                                        <table class="table table-hover table-sm">
                                            ...
                                            <tfoot>
                                                <tr class="table-secondary fw-bold">
                                                    ...
                                                    <td align="right"><?=FormatSayi::sayi($row_toplam->FIYAT,2)?> ₺</td>
                                                    <td align="center"><?=FormatSayi::sayi($row_toplam->ADET,0)?></td>
                                                    <td align="right"><?=FormatSayi::sayi($row_toplam->TUTAR,2)?> ₺</td>
                                                    <td colspan="2"></td>
                                                </tr>
                                            </tfoot>
                                        </table>
